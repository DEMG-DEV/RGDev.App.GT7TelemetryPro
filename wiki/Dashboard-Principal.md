...
> **Archivo:** `ui/main_window.py` · **Clase:** `TelemetryMainWindow` · **684 líneas**
...
Muestra datos de la vuelta actual y el vehículo en pista en tiempo real:

| Dato | Formato | Detalle |
|------|---------|---------|
| Auto | Texto | Nombre estandarizado del auto (`gt7_cars.json`, 580 modelos) |
| Thumbnail | `QLabel` | Fotografía HD del auto en pista (570 imágenes PNG offline), con auto-detección a 60 FPS y caché `_current_car_code` |
